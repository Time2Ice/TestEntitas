...
public partial class GameEntity {
    ...
    public void AddView(UnityEngine.GameObject newGameObject, UnityEngine.SpriteRenderer newSpriteRenderer) {
    ...
    public void ReplaceView(UnityEngine.GameObject newGameObject, UnityEngine.SpriteRenderer newSpriteRenderer) {
        var index = GameComponentsLookup.View;
        var component = (ViewComponent)CreateComponent(index, typeof(ViewComponent));
        component.GameObject = newGameObject;
        component.SpriteRenderer = newSpriteRenderer;
